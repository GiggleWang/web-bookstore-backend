...
public interface OrderRepository extends JpaRepository<Order, Integer> {
    @Query("SELECT o FROM Order o JOIN o.items i JOIN i.book b WHERE b.name LIKE CONCAT('%', :bookName, '%')")
    ...
    @Query("SELECT o FROM Order o JOIN o.items i JOIN i.book b WHERE b.name LIKE CONCAT('%', :bookName, '%') AND o.orderDate BETWEEN :start AND :end")
    ...
    @Query("SELECT o FROM Order o JOIN o.items i JOIN i.book b WHERE b.name LIKE CONCAT('%', :bookName, '%') AND o.orderDate BETWEEN :startDate AND :endDate")
    ...
    @Query("SELECT o FROM Order o JOIN o.items i JOIN i.book b WHERE o.userId = :userId AND b.name LIKE CONCAT('%', :bookName, '%') AND o.orderDate BETWEEN :startDate AND :endDate")
    ...
    @Query("SELECT o FROM Order o WHERE o.userId = :userId AND o.orderDate BETWEEN :start AND :end")
    ...
    @Query("SELECT o FROM Order o JOIN o.items i JOIN i.book b WHERE o.userId = :userId AND b.name LIKE CONCAT('%', :bookName, '%')")
    Page<Order> findByUserIdAndBookName(@Param("userId") Integer userId, @Param("bookName") String bookName, Pageable pageable);

    @Query("SELECT o FROM Order o JOIN o.items i JOIN i.book b WHERE o.userId = :userId AND b.name LIKE CONCAT('%', :bookName, '%') AND o.orderDate BETWEEN :start AND :end")
